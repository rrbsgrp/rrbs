...
describe "settlement_sales/new.html.erb" do
  before(:each) do
    assign(:settlement_sale, stub_model(SettlementSale,
      :ss_amount => 1.5,
      :st_id => 1,
      :stemployee_id => 1,
      :vat => 1.5,
  ...
  it "renders new settlement_sale form" do
    ...
    assert_select "form", :action => settlement_sales_path, :method => "post" do
